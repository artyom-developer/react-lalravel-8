    ...
    <div>
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          onChange={(event)=>setCity(event.target.value)} value={city} onChange={(event)=>setCity(event.target.value)}>
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control" placeholder="1234 Main St" value={address} onChange={(event)=>setAddress(event.target.value)} />
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control" placeholder="123467890" value={phone} onChange={(event)=>setPhone(event.target.value)}/>
        </div>
      </div>
